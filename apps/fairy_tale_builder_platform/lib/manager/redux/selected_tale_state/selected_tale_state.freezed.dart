...
class _$SelectedTaleStateImpl extends _SelectedTaleState {
  ...
  @override
  String toString() {
    return 'SelectedTaleState(taleResult: $taleResult, tale: $tale, pages: $pages, interactions: $interactions, selectedPageId: $selectedPageId, selectedInteractionId: $selectedInteractionId)';
  }
...
abstract class _SelectedTaleState extends SelectedTaleState {
  const factory _SelectedTaleState(
      ...
      required final String selectedInteractionId}) = _$SelectedTaleStateImpl;
