...
abstract class TextComponent extends StatelessWidget {
  ...
  factory TextComponent.hardCoded(String text, {bool ignoreLog}) = HardCodedTextComponent;

  const factory TextComponent.number(num number) = NumberTextComponent;

  const factory TextComponent.any(dynamic value, {int maxLines, TextOverflow overflow}) = AnyTextComponent;
